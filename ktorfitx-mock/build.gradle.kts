...
group = "cn.vividcode.multiplatform.ktorfitx.mock"
	...
	sourceSets {
		commonMain {
			dependencies {
				...
				api(projects.ktorfitxCore)
				implementation(libs.bundles.ktorfitx.mock)
			}
		}
	}
}
...
android {
	namespace = "cn.vividcode.multiplatform.ktorfitx.mock"
...
mavenPublishing {
	...
	coordinates("cn.vividcode.multiplatform", "ktorfitx-mock", ktorfitxVersion)
	
	pom {
		name.set("ktorfitx-mock")
