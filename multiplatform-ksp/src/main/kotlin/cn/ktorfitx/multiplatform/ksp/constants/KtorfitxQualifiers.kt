...
internal object KtorfitxQualifiers {
	...
	private const val PACKAGE_ANNOTATION = "cn.ktorfitx.multiplatform.annotation"
	
	const val PACKAGE_CORE = "cn.ktorfitx.multiplatform.core"
	
	const val PACKAGE_CORE_EXPENDS = "cn.ktorfitx.multiplatform.core.expends"
	
	const val PACKAGE_MOCK = "cn.ktorfitx.multiplatform.mock"
	
	const val PACKAGE_MOCK_CONFIG = "$PACKAGE_MOCK.config"
	
	private const val PACKAGE_WEB_SOCKETS = "cn.ktorfitx.multiplatform.websockets"
