...
group = "cn.vividcode.multiplatform.ktorfitx.core"
...
kotlin {
	...
	js {
		...
		browser {
			commonWebpackConfig {
				outputFileName = "ktorfitxCore.js"
			}
		}
		binaries.executable()
		useEsModules()
	...
	sourceSets {
		commonMain {
			dependencies {
				...
				implementation(libs.bundles.ktorfitx.core)
			}
		}
	}
}
...
android {
	namespace = "cn.vividcode.multiplatform.ktorfitx.core"
...
mavenPublishing {
	...
	coordinates("cn.vividcode.multiplatform", "ktorfitx-core", ktorfitxVersion)
	
	pom {
		name.set("ktorfitx-core")
